    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        menu01Button.setOnClickListener(new OnClickListener() {
            public void onClick(View v) {
                ...
                intent.putExtra("titleMsg", "오늘의 기록");
        ...
        menu02Button.setOnClickListener(new OnClickListener() {
            public void onClick(View v) {
                ...
                intent.putExtra("titleMsg", "오늘의 기분");
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent intent) {
        ...
        if (intent != null) {
            if (requestCode == REQUEST_CODE_CUSTOMER) {
                ...
                if (message != null) {
                    Toast toast = Toast.makeText(getBaseContext(), "오늘의 기록, result code : " + resultCode + ", message : " + message, Toast.LENGTH_LONG);
                    toast.show();
                }
                ...
                if (message != null) {
                    Toast toast = Toast.makeText(getBaseContext(), "오늘의 기분, result code : " + resultCode + ", message : " + message, Toast.LENGTH_LONG);
                    toast.show();
                }
